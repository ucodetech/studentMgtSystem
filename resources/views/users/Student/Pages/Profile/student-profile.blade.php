    ...
    <div class="col-md-4 col-xl-3">
        <div class="card mb-3">
            ...
            <div class="card-body text-center">
                <div id="previewPhoto">
                    <label for="photo" class="cursor-pointer" title="Click to select new photo">
                ...
                <form action="{{ route('user.user.update.photo') }}" method="POST" enctype="multipart/form-data" id="updateStudentPhotoForm">
                    @csrf
                    @method("POST")
                ...
                <div class="tab-content">
                  <div class="tab-pane active" id="details" role="tabpanel" aria-labelledby="details-tab"> 
                    ...
                    <div class="container mt-3">
                        <form action="{{ route('user.user.update.details') }}" method="POST">
                            @csrf
                            @method("POST")
                            <div class="mb-3 row">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-8">
                                    <input type="email" class="form-control" placeholder="email" value="{{ student()->email }}" disabled>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="phone_no" class="col-4 col-form-label">Phone Number</label>
                                <div class="col-8">
                                    <input type="tel" class="form-control" name="phone_no" id="phone_no" placeholder="phone" value="{{ student()->phone_no }}">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="matric_no" class="col-4 col-form-label">Matric No</label>
                                <div class="col-8">
                                    <input type="matric_no" class="form-control" placeholder="matric_no" value="{{ student()->matric_no }}" disabled>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="level" class="col-4 col-form-label">Level</label>
                                <div class="col-8">
                                    <input type="level" class="form-control" placeholder="level" value="{{ student()->level }}" disabled>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="department" class="col-4 col-form-label">Department</label>
                                <div class="col-8">
                                    <input type="text" class="form-control" value="{{ student()->department }}" @readonly(true)>
                                </div>
                            </div>
                            <div class="mb-3 row">
                        ...
                        <form action="{{ route('user.user.update.password') }}" method="POST">
                            @csrf
                            @method("POST")
